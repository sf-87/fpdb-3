...
class GuiCashPlayerStats(QSplitter):
    def __init__(self, db, parent):
        ...
        self.db = db
        self.columns = ["Stakes", "#", "VPIP", "PFR", "PF3Bet", "PF4Bet", "Steal", "BBStol", "SBStol", "RTS", "WTSD", "WWSF", "Net", "BB/100"]
        self.hands_columns = ["Hand", "#", "VPIP", "PFR", "PF3Bet", "PF4Bet", "Steal", "BBStol", "SBStol", "RTS", "WTSD", "WWSF", "Net"]
