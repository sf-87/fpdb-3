class Sql(object):
    def __init__(self):
        ...
        self.query["createHandPlayersTable"] = """CREATE TABLE HandPlayers (
                    ...
                    street1Seen INTEGER NOT NULL,
                    street2Seen INTEGER NOT NULL,
                    street3Seen INTEGER NOT NULL,
                    ...
                    wonWhenSeenStreet1 INTEGER NOT NULL,
        ...
        self.query["insertHandPlayer"] = """INSERT INTO HandPlayers (handId, playerId, startStack, startBounty, endBounty, position,
                                                                     ...
                                                                     raiseToStealChance, raiseToStealDone, stealChance, stealDone, street1Seen, street2Seen,
                                                                     street3Seen, sawShowdown, otherRaisedStreet1, otherRaisedStreet2, otherRaisedStreet3, foldToOtherRaisedStreet1,
                                                                     foldToOtherRaisedStreet2, foldToOtherRaisedStreet3, wonWhenSeenStreet1, foldBBToStealChance, foldedBBToSteal, foldSBToStealChance,
                                                                     foldedSBToSteal, street1CBChance, street1CBDone, street2CBChance, street2CBDone, street3CBChance,
                                                                     street3CBDone, foldToStreet1CBChance, foldToStreet1CBDone, foldToStreet2CBChance, foldToStreet2CBDone, foldToStreet3CBChance,
                                                                     foldToStreet3CBDone, street1CheckRaiseChance, street1CheckRaiseDone, street2CheckRaiseChance, street2CheckRaiseDone, street3CheckRaiseChance,
        ...
        self.query["insertHudCache"] = """INSERT INTO HudCache (gameTypeId, playerId, seats, n, street0VPIChance, street0VPI,
                                                                ...
                                                                stealChance, stealDone, street1Seen, street2Seen, street3Seen, sawShowdown,
                                                                otherRaisedStreet1, otherRaisedStreet2, otherRaisedStreet3, foldToOtherRaisedStreet1, foldToOtherRaisedStreet2, foldToOtherRaisedStreet3,
                                                                wonWhenSeenStreet1, foldBBToStealChance, foldedBBToSteal, foldSBToStealChance, foldedSBToSteal, street1CBChance,
        ...
        self.query["getHudStats"] = """SELECT hc.playerId                       AS player_id,
                                              ...
                                              SUM(hc.wonWhenSeenStreet1)        AS won_saw_1,
        ...
        self.query["getCashDetailedStats"] = """SELECT printf("%.2f/%.2f", gt.smallBlind, gt.bigBlind)                                                                                                          AS stakes,
                                                       ...
                                                       CASE WHEN SUM(hp.street1Seen) = 0 THEN NULL ELSE printf("%.1f", (CAST(SUM(hp.sawShowdown) AS REAL) / SUM(hp.street1Seen)) * 100) END                     AS wtsd,
                                                       CASE WHEN SUM(hp.street1Seen) = 0 THEN NULL ELSE printf("%.1f", (CAST(SUM(hp.wonWhenSeenStreet1) AS REAL) / SUM(hp.street1Seen)) * 100) END              AS wwsf,
